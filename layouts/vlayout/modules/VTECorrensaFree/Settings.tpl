...
<div class="container-fluid">
    <div class="corrensa-settingpage">
        ...
        <div class="integrate">
            <p><span class="integration-status">Integration Status</span> <label class="tgl"> <input type="checkbox" name="enable_module" id="enable_module" {if $ENABLE eq '1'}checked="" {/if}/> <span data-on="On" data-off="Off" id="enable_module"></span> </label></p>
        </div>
